...
////////////////////////////////////////////////////////////////////////////////
    ...
    /* STM32H5 family */
    #define CONFIG_STM32_HAL_HDR "stm32h5xx_hal.h"
    /* Use USART3 as the console for this board */
    #define CONFIG_CONSOLE_UART huart3
    /* Modern STM32 has Alternate in GPIO_InitTypeDef */
    #define CONFIG_GPIO_TYPE 2

    /* Compatibility: older app uses GPIO_SPEED_LOW name */
